...
#define BL_DB_CACHE_STATISTICS 0
...
@interface BLDBCacheItem : NSObject {
@public
    __unsafe_unretained BLDBCacheItem *prev; // retained by cfdict
    __unsafe_unretained BLDBCacheItem *next; // retained by cfdict
...
@protocol BLDBCacheDelegate;

@interface BLDBCache : NSObject
...
@property (nonatomic, weak) id<BLDBCacheDelegate> delegate;

@end

@protocol BLDBCacheDelegate <NSObject>
